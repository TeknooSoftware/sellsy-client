...
/**
 * @covers \Teknoo\Sellsy\Client\Exception\ObjectNotLoadableException
 *
 * @copyright   Copyright (c) EIRL Richard Déloge (richard@teknoo.software)
 * @copyright   Copyright (c) SASU Teknoo Software (https://teknoo.software)
 * @license     http://teknoo.software/sellsy-client/license/mit         MIT License
 * @author      Richard Déloge <richard@teknoo.software>
 */
class ObjectNotLoadableExceptionTest extends AbstractExceptionTests
{
    protected function buildException(
        ...
        return new ObjectNotLoadableException($result, $previous);
    }
}
