...
/**
 * @covers \Teknoo\Sellsy\Client\Exception\SubscribtionRequiredException
 *
 * @copyright   Copyright (c) EIRL Richard Déloge (richarddeloge@gmail.com)
 * @copyright   Copyright (c) SASU Teknoo Software (https://teknoo.software)
 * @license     http://teknoo.software/sellsy-client/license/mit         MIT License
 * @author      Richard Déloge <richarddeloge@gmail.com>
 */
class SubscribtionRequiredExceptionTest extends AbstractExceptionTests
{
    protected function buildException(
        ...
        return new SubscribtionRequiredException($result, $previous);
    }
}
